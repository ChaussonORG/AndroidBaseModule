...
/**
 * Created by Samuel on 5/25/16 17:25
...
public class ResetPassword {
    ...
    public void doReset(String phone, String password, String code) {
        if (checkInputValidity(phone, password, code) == 1) {
            ...
            Call<BaseResponse<Object>> call = baseService.resetPassword(registRequest);
